...
export const seedData: AppData = {
  ...
  fixedExpenses: [
    { id: "fx-affitto", name: "Affitto", categoryId: "utilities", amount: 845 },
    { id: "fx-condominio", name: "Spese condominiali", categoryId: "utilities", amount: 190 },
    { id: "fx-luce", name: "Luce", categoryId: "utilities", amount: 60 },
    { id: "fx-wifi", name: "Wifi", categoryId: "utilities", amount: 22.99 },
    { id: "fx-icloud", name: "ICloud", categoryId: "services", amount: 2.99, note: "200 GB" },
    { id: "fx-applemusic", name: "Apple Music", categoryId: "services", amount: 5.99 },
    { id: "fx-lte", name: "Mobile LTE", categoryId: "services", amount: 9.99 },
    { id: "fx-claude", name: "Claude", categoryId: "services", amount: 18 },
    { id: "fx-benzina", name: "Benzina", categoryId: "transport", amount: 50 },
    { id: "fx-atm", name: "ATM", categoryId: "transport", amount: 22, note: "Abbonamento mensile" },
    { id: "fx-palestra", name: "Palestra", categoryId: "healt", amount: 50, note: "McFit" },
    { id: "fx-assauto", name: "Insurance AUTO", categoryId: "insurance", amount: 45 },
    { id: "fx-uni-tasse", name: "Tasse universitarie", categoryId: "university", amount: 225 },
    { id: "fx-uni-extra", name: "Materiale universitario", categoryId: "university", amount: 25 },
  ],
